 ...
 */
 ...
 public class JavaApplication2 {
     ...
     public static void dijkstra(Map<Integer, List<Node>> graph, int source, int n, String[] vertexNames) {
         ...
         int[] prev = new int[n]; // Array para armazenar os predecessores no caminho mínim
         ...
         // Imprime as distâncias e os caminhos mais curtos do vértic de origem para todos os outros vértices
         for (int i = 0; i < n; i++) {
             if (i != source) {
     ...
     // Método uxiliar para imprimir  o caminho do vértice de origem até o vértice destino
     public static void printPath(int[] prev, int vertex, String[] vertexNames) {
         ...
         // Imprime o caminho no formato "Y -> B -> ..."
